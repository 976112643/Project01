...
public class NavigatorActivity extends LBaseActivity {
    ...
    private void initNavTabView() {
        ...
        navTabView.addItem(navbars[0] = new BottomNavigationItem(R.drawable.micon_index_select, "首页").setInactiveIconResource(R.drawable.micon_index));//;.setBadgeItem(badgeItems[0] = new BadgeItem().hide(false)));
        navTabView.addItem(navbars[1] = new BottomNavigationItem(R.drawable.micon_gains_select, "圈子").setInactiveIconResource(R.drawable.micon_gains));//.setBadgeItem(badgeItems[1] = new BadgeItem().hide(false)));
        navTabView.addItem(navbars[2] = new BottomNavigationItem(R.drawable.micon_mine_select, "我的").setInactiveIconResource(R.drawable.micon_mine));//.setBadgeItem(badgeItems[2] = new BadgeItem().hide(false)));
